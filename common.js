...
let NavigationService = class NavigationService {
    constructor(nav, location, alert) {
        this.nav = nav;
    ...
    goto_page(page) {
        this.nav.navigateForward(page, { animationDirection: "forward" });
    }
    goto_about() {
        this.nav.navigateForward("about", { animationDirection: "forward" });
    }
    goto_resume() {
        this.nav.navigateForward("resume", { animationDirection: "forward" });
    }
    goto_blogs() {
        this.nav.navigateForward("blogs", { animationDirection: "forward" });
    }
    goto_work() {
        this.nav.navigateForward("works", { animationDirection: "forward" });
    }
    go_back() {
        this.location.back();
    }
...
/* harmony export */ });
/* harmony import */ var G_My_Projects_portfolio_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,G_My_Projects_portfolio_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,G_My_Projects_portfolio_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,G_My_Projects_portfolio_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
